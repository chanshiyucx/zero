...
interface EnglishProps extends SVGProps<SVGSVGElement> {
  weight?: 'duotone' | 'regular'
}

export function English({ weight = 'regular', ...props }: EnglishProps) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 100 100" {...props}>
      {weight === 'duotone' && (
        <path
          className="fill-subtle/20"
          d="M84,5H16C9.9,5,5,9.6,5,15.3V67c0,5.7,4.9,10.3,11,10.3h7.2v15.3c0,0.9,0.6,1.8,1.5,2.2c0.4,0.2,0.7,0.2,1.1,0.2c0.6,0,1.2-0.2,1.7-0.5l22.7-17.2H84c6.1,0,11-4.6,11-10.3V15.3C95,9.6,90.1,5,84,5z"
        />
      )}
      <g
        fill="currentColor"
